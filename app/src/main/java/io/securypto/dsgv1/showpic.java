...
public class showpic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmapreceived = BitmapFactory.decodeByteArray(decoded, 0, decoded.length);

        ImageView mImageView;
        mImageView = (ImageView) findViewById(R.id.imageholdershowpic);
        mImageView.setImageBitmap(bitmapreceived);

        ZoomageView imageZoom = (ZoomageView)findViewById(R.id.imageholdershowpic);
